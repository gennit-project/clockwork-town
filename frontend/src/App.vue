            ...
            <div class="flex items-center space-x-3">
              ...
              <div class="flex items-center space-x-2 bg-gray-100 dark:bg-gray-700 px-3 py-1.5 rounded-lg">
                ...
                <div class="flex items-center space-x-1.5">
                  ...
                  <span class="font-mono text-xs font-semibold text-gray-900 dark:text-gray-100" :title="simulationStore.formattedSimulationDateTime">
                    {{ simulationStore.currentTick }}
                  </span>
                </div>
                <span class="hidden text-xs font-medium text-gray-700 dark:text-gray-300 xl:inline">
