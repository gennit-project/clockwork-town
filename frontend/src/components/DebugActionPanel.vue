<template>
  <div class="bg-gf-surface border border-gf-amber rounded-lg p-4 mb-4">
    <div class="flex justify-between items-center mb-3">
      <h3 class="text-sm font-bold text-gf-amber flex items-center">
        <span class="mr-2">🔧</span>
        Debug: Test Action Effects
      </h3>
      <button
        @click="$emit('close')"
        class="text-gf-text-weak hover:text-gf-text"
      >
    ...
    <div v-if="selectedCharacterId" class="space-y-2">
      <p class="text-xs text-gf-text-weak mb-2">
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 gap-2">
        ...
        <button
          ...
          class="px-3 py-2 text-xs font-medium rounded border border-gf-border bg-gf-green/15 text-gf-green hover:bg-gf-green/25"
        ...
        <button
          ...
          class="px-3 py-2 text-xs font-medium rounded border border-gf-border bg-gf-blue/15 text-gf-blue hover:bg-gf-blue/25"
        ...
        <button
          ...
          class="px-3 py-2 text-xs font-medium rounded border border-gf-border bg-gf-red/15 text-gf-red hover:bg-gf-red/25"
        ...
        <button
          ...
          class="px-3 py-2 text-xs font-medium rounded border border-gf-border bg-gf-purple/15 text-gf-purple hover:bg-gf-purple/25"
      ...
      <div class="mt-3 pt-3 border-t border-gf-border">
        <p class="text-xs font-medium text-gf-text-weak mb-2">
          🔍 Test Item Finding (Same Space + Lot + Region):
        </p>
        <div class="grid grid-cols-2 gap-2">
          <button
            @click="testFindItems('eat')"
            class="px-3 py-1.5 text-xs font-medium rounded border border-gf-border bg-gf-surface text-gf-text-weak hover:bg-gf-surface-2"
          >
            Find 'eat' items
          </button>
          <button
      ...
      <div class="mt-3 pt-3 border-t border-gf-border">
        ...
        <button
          ...
          class="w-full px-3 py-2 text-xs font-medium rounded border border-gf-border bg-gf-blue/15 text-gf-blue hover:bg-gf-blue/25"
        >
      ...
      <div class="mt-3 pt-3 border-t border-gf-border">
        ...
        <button
          ...
          class="w-full px-3 py-2 text-xs font-medium rounded border border-gf-border bg-gf-green/15 text-gf-green hover:bg-gf-green/25"
        >
      ...
      <div class="mt-3 pt-3 border-t border-gf-border">
        <p class="text-xs text-gf-text-weak">
    ...
    <div v-else class="text-xs text-gf-text-faint text-center py-4">
